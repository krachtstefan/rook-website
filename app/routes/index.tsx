    ...
    <Layout>
      ...
      <SectionContainer>
        ...
        <SectionParagraph>
          ...
          askmeabout@rook.computer. We do not have any commercial interests and
          promise to only send interesting and fun stuff your way :)
        </SectionParagraph>
      ...
      <SectionContainer>
        ...
        <SectionParagraph>
          ...
          pixel could define an entire character, and joypads had fewer buttons
          than a modern car’s dashboard.
        </SectionParagraph>
        <SectionParagraph>
          And there’s more: You can design and print your own RooK case, making
          it truly yours. Because what’s cooler than beating your high score?
          Beating it on a console YOU designed. Take that, Nintendo Labo!
        </SectionParagraph>
      ...
      <SectionContainer>
        ...
        <SectionParagraph>
          In short: For the reason that’s usually the worst of all reasons. But
          in this case, it’s the best:{" "}
          <b className="uppercase">Because you can</b>. 😎
        </SectionParagraph>
        <SectionParagraph>
          And let’s be honest, we’re all still waiting for that one feature from
          our childhood consoles that never quite made it into mass production.
          Now’s our chance to make it happen, one 3D-printed case at a time.
        </SectionParagraph>
      </SectionContainer>
      ...
      <SectionContainer>
        ...
        <SectionParagraph>
          Because: Time spent together playing is not screen time, it’s quality
          time! Just like in the old days when multiplayer meant huddling around
          a single TV, rather than shouting at each other through headsets.
        </SectionParagraph>
        <SectionParagraph>
          Retro games are so well suited for this because they are easy to play
          but hard to master. It’s much easier for kids to spend 60 or 70 tries
          beating a level boss, and then eventually turn off the console because
          a) it’s exhausting and challenging, and b) it’s still fun and
          fulfilling to do hard things.
        </SectionParagraph>
        <SectionParagraph>
        ...
        <SectionParagraph>
          ...
          instead of Netflix, TikTok, or our family. They’re like digital sugar
          rushes – thrilling in the moment, but leaving you with a crash. Retro
          games are more like a slow-cooked meal; satisfying and wholesome.
        </SectionParagraph>
        <SectionParagraph>
          As nerdy parents, we want to enable our kids to game, but also protect
          them from hyper-stimulating games. When you observe your children
          playing Super Mario or Tetris compared to modern Switch games, we’ve
          consistently found that older games evoke just as much fascination but
          have much less addictive potential. Kids can regulate themselves much
          better with older games that have less overstimulation. Plus, no
          microtransactions or loot boxes trying to raid your piggy bank.
        </SectionParagraph>
        <SectionParagraph>
          ...
          plays or music – but just for gaming. Sure, a cartridge could contain
          hundreds of games, but that would helplessly overwhelm and
      ...
      <SectionContainer>
        ...
        <SectionParagraph>
          It all started when Enno wanted to learn how to source fully assembled
          PCBs. He already used the software{" "}
          <a
          ...
          because it would give him a much larger inventory of chips for his own
          projects. The only problem: he lacked a concrete project. So, like any
          good engineer, he went looking for a problem to solve with his
          newfound knowledge.
        </SectionParagraph>
        ...
        <SectionParagraph>
          ...
          annoying. Even if his museum pieces exert a special fascination on the
          kids. (more on that below) Clearly, the magic of blowing into a
          cartridge and waiting an eternity for the game to load was lost on the
          younger generation.
        </SectionParagraph>
      ...
      <SectionContainer>
        ...
        <SectionParagraph>
          We found the idea charming to retain the retro gaming character – even
          in the external design. Because if it doesn’t look like it came
          straight out of 1989, are you really retro gaming?
        </SectionParagraph>

        <SectionParagraph>
          We could go crazy and design and print a separate console case for
          each system! Meaning: For PS2 games, a PS2 case that incorporates and
          reproduces the console’s design. Then each station directly makes it
          clear what’s being played here. Imagine a whole wall of
        ...
        <SectionParagraph>
          ...
          old consoles. There’s just something about holding a piece of history
          in your hands, even if that history sometimes emitted a high-pitched
          whine.
        </SectionParagraph>
        ...
        <SectionParagraph>
          ...
          But the result was impressive, and the form factor was born. It’s also
          funny that a USB-A plug fits exactly into the gap of 2 LEGO studs.
          Almost like it was meant to be.
        </SectionParagraph>

        <SectionParagraph>
          So Enno had both a 3D model of the case to build a board that could be
          ordered from China. The circle of life for a DIY console: design,
          build, source, repeat.
        </SectionParagraph>
      </SectionContainer>
    </Layout>
